...
# Load MFCC features
track_genres_mfcc = pd.read_pickle('data/processed/track_genres_spectograms.pkl')

# Obtain X and y sets
X = np.array(track_genres_mfcc['spectogram'])
...
def train(model=initial_model, epochs=10, batch_size=3):
    # Compilation
