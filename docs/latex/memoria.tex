...
En este proyecto, se utilizan métodos de inteligencia artificial (IA) con el fin de clasifiicar de forma automática diferentes géneros musicales a partir de un análisis de las características del audio. 
...
%\include{./tex/3_Theorical_concepts}
...
%\include{./tex/7_Conclusions_Future_works}
