...
\imagen{accuracy_17L}{Proceso de entrenamiento del modelo 1, mostrando la medida \textit{accuracy}}{0.75}
\imagen{Loss_17L}{Proceso de entrenamiento del modelo 1, mostrando la medida \textit{loss}}{0.75}

\textbf{Entrenamiento del modelo 2}

\imagen{accuracy_11L}{Proceso de entrenamiento del modelo 2, mostrando la medida \textit{accuracy}}{0.75}
\imagen{Loss_11L}{Proceso de entrenamiento del modelo 2, mostrando la medida \textit{loss}}{0.75}

\textbf{Entrenamiento del modelo 3}

\imagen{accuracy_8L}{Proceso de entrenamiento del modelo 3, mostrando la medida \textit{accuracy}}{0.75}
\imagen{Loss_8L}{Proceso de entrenamiento del modelo 3, mostrando la medida \textit{loss}}{0.75}
